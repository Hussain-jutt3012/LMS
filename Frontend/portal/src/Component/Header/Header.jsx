                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center justify-between h-20">
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                {!isLoading && authstatus && (
                                    <span className="absolute -right-1 -bottom-1 w-4 h-4 bg-emerald-500 border-2 border-slate-950 rounded-full shadow-lg shadow-emerald-500/30" />
                                )}
                        ...
                        <nav className="flex items-center gap-2 sm:gap-4">
                            ...
                            {/* 
                                IMPORTANT:
                                During refresh, isLoading = true.
                                So Login / Logout won't flash.
                            */}
